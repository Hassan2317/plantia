...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    enableWeatherAlerts: 'Enable Alerts',
    weatherAlertsEnabled: 'Alerts Enabled',
    weatherAlertsDenied: 'Alerts Blocked',
    criticalAlerts: 'Critical Weather Alerts',
    alertDescription: 'Receive notifications for events like frost or heavy rain.',
    weatherAlertTitle: 'CROPIA Weather Alert',
    frostAlert: 'Frost warning for {day}: low of {low}°C. Protect sensitive crops!',
    rainAlert: 'Heavy rain warning for {day}: {description}. Watch out for flooding.',
    // Knowledge Base
  ...
  ny: { // Chichewa translations
    ...
    enableWeatherAlerts: 'Yambitsani Zidziwitso',
    weatherAlertsEnabled: 'Zidziwitso Zili ON',
    weatherAlertsDenied: 'Zidziwitso Zili OFF',
    criticalAlerts: 'Machenjezo Ofunika a Nyengo',
    alertDescription: 'Landirani zidziwitso za zochitika monga chisanu kapena mvula yamphamvu.',
    weatherAlertTitle: 'Chenjezo la Nyengo la CROPIA',
    frostAlert: 'Chenjezo la chisanu pa {day}: kutentha kochepa {low}°C. Tetezani mbeu zanu!',
    rainAlert: 'Chenjezo la mvula yamphamvu pa {day}: {description}. Samalani ndi kusefukira kwa madzi.',
    // Knowledge Base
